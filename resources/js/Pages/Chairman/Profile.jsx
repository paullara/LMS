...
import CreatedSchedule from "@/Components/Profile/CreatedSchedule";
import UpcomingList from "@/Components/Profile/UpcomingList";
import EditProfileForm from "@/Components/Form/EditProfileForm";

import formatTime from "@/Utils/formatTime";

export default function Profile({ createdClasses }) {
    const { auth } = usePage().props;
    const [loading, setLoading] = useState(true);
    const [isEditMode, setIsEditMode] = useState(false);

    useEffect(() => {
        if (createdClasses !== undefined) setLoading(false);
    }, [createdClasses]);
