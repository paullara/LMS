            ...
            <div className="relative bg-[#f9f9f9] text-black overflow-x-hidden font-poppins scroll-container">
               ...
               bg-white text-center px-10 pt-20 overflow-hidden opacity-0 hero-wrapper"
                ...
                >
                    ...
                    <div className="relative w-3/4 flex flex-col justify-center items-center mt-10">
                        {/* Vertical line */}
                        <div className="absolute top-0 bottom-0 left-1/2 transform -translate-x-1/2 w-1 bg-blue-400 z-0"></div>
